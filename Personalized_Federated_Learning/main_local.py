...
def parse_args():
    ...
    parser.add_argument('-ccm', "--cross_client_modulus", type=int, default=10,
    ...
    # JR doesn't matter for LOCAL algorithm, all clients are used (select_clients() is not run)
    parser.add_argument('-jr', "--join_ratio", type=float, default=0.3,
                        help="Fraction of clients to be active in training per round")
    # I think they are saved no matter what... I don't remember using this...
